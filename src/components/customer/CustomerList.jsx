...
import { Transition, getGender } from "../configs/functions";
  ...
  return (
    <div className="customer-list">
      ...
      >
        ...
        <DialogContent>
          <ViewCustomer customer={customerInfo} avatar={avatar} />
        </DialogContent>
        <DialogActions>
...
export const ViewCustomer = (props) => {
  return props.customer !== undefined && props.avatar !== undefined ? (
    <div className="view-customer">
      ...
      <tr>
        <th>Giới tính</th>
        <td>{getGender(props.customer.gender)}</td>
      </tr>
      <tr>
        <th>Ngày sinh</th>
        <td>
          {props.customer.date !== undefined
            ? props.customer.date == null
              ? ""
              : new Date(props.customer.date).toLocaleDateString("en-GB")
            : ""}
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <th>Ngày đăng ký</th>
        <td>
          {props.customer.registerDate !== undefined
            ? props.customer.registerDate == null
              ? ""
              : new Date(props.customer.registerDate).toLocaleDateString(
                  "en-GB"
                )
            : ""}
        </td>
      ...
      <tr>
        ...
        <td>
          {props.customer.balance !== undefined
            ? dot3digits(props.customer.balance)
            : 0}{" "}
          VNĐ
        </td>
      </tr>
